...
let estado={resultados:{},mataMata:[],ranking:[]};
...
$('salvar').onclick=async()=>{try{const palpites=lerInputs('p');const data=await api('/api/palpites',{method:'POST',token,body:JSON.stringify({palpites})});estado.ranking=data.ranking;toast('Palpites salvos!')}catch(e){toast(e.message)}}
